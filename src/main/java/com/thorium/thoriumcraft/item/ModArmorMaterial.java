...
public enum ModArmorMaterial implements ArmorMaterial {
    ...
    */
    THORIUM("thorium", 26, new int[]{4, 7, 9, 4}, 26, SoundEvents.ARMOR_EQUIP_IRON, 1.5F, 0.1F, () -> {
        return Ingredient.of(ModItems.THORIUM_INGOT.get());
    });
    ...
    private ModArmorMaterial(String name, int durabilityMultiplier, int[] protection, int enchantmentModifier, SoundEvent sound, float toughness, float knockbackResistance, Supplier<Ingredient> material) {
        this.name = name;
        ...
        this.repairIngredient = new LazyLoadedValue<>(material);
    }
    ...
    public String getName() {
        return Thoriumcraft.MOD_ID+":"+this.name;
    }
